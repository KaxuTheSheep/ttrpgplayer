...
tags:
  ...
  - Lore
---
Divinity is the expression of a Deity's power through a Follower's [[Soul|soul]]. Where [[Magic]] is a mage shaping [[mana]] with their own understanding and control, Divinity is a Deity acting through the persistent resonant link formed when a Follower's [[Soul|soul]]-current synchronises with the Deity's [[Mana|mana]] construct — see [[Soul]] for the underlying mechanism. The [[Soul|soul]] remains the Follower's own. The Deity runs alongside it, not through it.
...
[[Attributes|Resolve]] is the fixed casting [[Attributes|Attribute]] for every Incantation — unlike Flux Casting, there is no choice of [[Attributes|Insight]], [[Attributes|Resolve]], or [[Attributes|Presence]] per cast. Divinity is a matter of conviction, not technique.
...
> **Uses per Rest = [[Attributes|Resolve]] + N** (minimum 1)

**N** is a flat value set individually for that Incantation when it is created — some Incantations are demanding enough that N is negative, others generous enough that N is a healthy positive number. This mirrors how certain Racial Web abilities scale charges off an [[Attributes|Attribute]] (see the Cindral's *Sustained Burn* for a comparable precedent).

**Every cast consumes one use, whether it succeeds or fails.** This is the entire risk profile of an Incantation: they are safe — no Backlash, no lasting harm, no destabilised [[Soul|soul]] — but rigid and limited. A Follower who casts carelessly simply runs out. There is nothing to recover mid-Rest and no way to push past the limit; when the charges are spent, the Deity has nothing left to give until the Follower rests.
...
## Casting
**DN:** X
**Uses per Short Rest:** [[Attributes|Resolve]] + N *(state N per specific spell)*
**Casting [[Attributes|Attribute]]:** [[Attributes|Resolve]] *(always)*
