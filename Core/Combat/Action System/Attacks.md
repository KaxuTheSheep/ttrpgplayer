...
> Ranged attacks follow the same hit resolution — roll 2d10 + Grace against the target's Evasion. For ranged-specific rules including projectile travel, range penalties, and cover see [[Ranged Attacks]].

## Damage
- Damage is rolled on weapon-specific dice (e.g., 1d8 for a longsword).
- Heavy Attacks deal double damage, calculated by doubling the rolled damage.
- Some abilities also deal damage but may require the target to make an Attribute Test to resist or mitigate effects.
...
- Critical Failures are adjudicated by the GM.
