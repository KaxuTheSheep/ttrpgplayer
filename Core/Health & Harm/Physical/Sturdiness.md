...
## Calculation
**Sturdiness = Base Sturdiness + [[Attributes|Vitality]] + Bought Increases + Other Modifiers**
- **Base Sturdiness:** A starting value determined by your species or origin as defined in the relevant module.
...
- **Other Modifiers:** Bonuses or penalties from abilities, [[Conditions|conditions]], equipment, or situational factors.

## [[Damage Types|Damage]] Absorption
Sturdiness is a **depletable pool**, not a per-hit buffer. When your character takes [[Damage Types|damage]]:
1. [[Damage Types|Damage]] reduces your current Sturdiness total.
2. When Sturdiness reaches 0, any remaining [[Damage Types|damage]] from that hit carries over and reduces [[Blood]].
